...
Оффициальная страница мода: https://vk.com/rimworldonline
...
Текйщий сервер для игры и тестов 194.87.95.90 
...
Разработка задумывается из папки OnlineCity в игровой папки Mods
...
* StartPoint.cs - здесь точка запуска нашего мода. Сейчас тут два класса которые добавляют конпку на нижней панели в игре. И здесь же (в конструкторе) идет первая инициализация. Основная инициализация происходит после входа в игру (после логина или регистрации).
