...
namespace RimWorldOnlineCity
{
    public class Dialog_CreateWorld : Window
    {
        ...
        public string InputStoryteller { get; private set; }

        public StorytellerDef InputStorytellerDef { get; private set; }
        ...
        public override Vector2 InitialSize
        {
            ...
            get { return new Vector2(500f, 400f); } //новое поле ввода с описанием +50
        }
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            */
            ...
            mainListing.Gap(6f);
            if (mainListing.ButtonTextLabeled("OCity_Dialog_CreateWorld_Storyteller".Translate(), InputStoryteller))
            {
                List<FloatMenuOption> floatList1 = new List<FloatMenuOption>();
