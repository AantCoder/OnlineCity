...
namespace RimWorldOnlineCity.UI
{
    public class Dialog_BaseOnlineButton : Window
    {
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            {
                Loger.Log("Dialog_BaseOnlineButton Exception: " + e.Message + Environment.NewLine + e.ToString(), Loger.LogLevel.ERROR);
            }
        }
        ...
        public void DoTab1Contents(Rect inRect)
        {
            ...
            if (SelectTab1Type == "storm" || SelectTab1Type == "emp" || SelectTab1Type == "eclipse" || SelectTab1Type == "acid")
            {
        ...
        public void DoTab0Contents(Rect inRect)
        {
            ...
            if (SelectTab0Type == "raid")
            {
                ...
                if (Widgets.RadioButtonLabeled(rect, "OC_TrustRandy".Translate(), SelectTab0Faction == "randy"))
                {
                    StatusNeedUpdate = true;
                    SelectTab0Faction = "randy";
                }
                rect.y += rect.height;
            }
        ...
        public void DoTab1And2ContentsDown(Rect rect)
        {
            ...
            GUI.color = StatusCheck ? Color.green : Color.red; // ColoredText.RedReadable;
